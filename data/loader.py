...
class WhiteWineData(DataLoader):
    def __init__(self, path='data/winequality-white_test.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
...
class HillValleyData(DataLoader):
    def __init__(self, path='data/hill_valley_combined.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
