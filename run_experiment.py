...
if __name__ == '__main__':
    ...
    parser.add_argument('--all', action='store_true', default=True, help='Run all experiments')
    ...
    ds1_details = {
            ...
            'data': loader.WhiteWineData(verbose=verbose, seed=seed),
            'name': 'white_wine_data',
            'readable_name': 'White Wine Data',
    ...
    ds2_details = {
            ...
            #'data': loader.AmazonData(verbose=verbose, seed=seed),
            #'name': 'amazon',
            #'readable_name': 'Amazon', 

            'data': loader.HillValleyData(verbose=verbose, seed=seed),
            'name': 'hill_valley',
            'readable_name': 'Hill Valley', 
        }
